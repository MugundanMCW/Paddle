...
-DPYTHON_LIBRARY=%PYTHON_ROOT%\libs\Python313.lib ^
-DPYTHON_INCLUDE_DIR=%PYTHON_ROOT%\include ^
-DPython3_EXECUTABLE=%PYTHON_ROOT%\python.exe ^
-DPython3_LIBRARY=%PYTHON_ROOT%\libs\Python313.lib ^
-DPython3_INCLUDE_DIR=%PYTHON_ROOT%\include ^
-DPython3_ROOT_DIR=%PYTHON_ROOT% ^
-DWITH_ARM=ON ^
-DCBLAS_LIBRARIES=C:/openblas/lib/openblas.lib ^
-DCBLAS_INC_DIR=C:/openblas/include/openblas ^
-DOPENBLAS_SHARED_LIB=C:/openblas/bin/openblas.dll ^
